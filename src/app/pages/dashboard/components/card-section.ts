...
@Component({
	selector: 'app-dashboard-card-section',
	...
	template: `
		<div class="grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
			<div class="@container/card" hlmCard>
				...
				<div hlmCardFooter class="flex-col items-start gap-1.5 text-sm">
					<div class="line-clamp-1 flex gap-2 font-medium">
						Trending up this month <ng-icon hlm name="tablerTrendingUp" size="sm" />
					</div>
			...
			<div class="@container/card" hlmCard>
				...
				<div hlmCardFooter class="flex-col items-start gap-1.5 text-sm">
					<div class="line-clamp-1 flex gap-2 font-medium">
						Down 20.4% this month <ng-icon hlm name="tablerTrendingDown" size="sm" />
					</div>
			...
			<div class="@container/card" hlmCard>
				...
				<div hlmCardFooter class="flex-col items-start gap-1.5 text-sm">
					<div class="line-clamp-1 flex gap-2 font-medium">
						Strong user retention <ng-icon hlm name="tablerTrendingUp" size="sm" />
					</div>
			...
			<div class="@container/card" hlmCard>
				...
				<div hlmCardFooter class="flex-col items-start gap-1.5 text-sm">
					<div class="line-clamp-1 flex gap-2 font-medium">
						Steady performance increase <ng-icon hlm name="tablerTrendingUp" size="sm" />
					</div>
